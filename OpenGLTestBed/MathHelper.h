...
{
public:
    static glm::mat4 MatrixRotateX(float radians)
    {
        glm::mat4 results;
    ...
    static glm::mat4 MatrixRotateY(float radians)
    {
        glm::mat4 results = glm::mat4();
    ...
    static glm::mat4 MatrixRotateZ(float radians)
    {
        glm::mat4 results = glm::mat4();
        results[0][0] = cos(radians);
    ...
    static glm::mat4 MatrixTranslate(float x, float y, float z)
    {
        glm::mat4 results = glm::mat4();
        results[3][0] = x;
        results[3][1] = y;
    ...
    static glm::mat4 MatrixScale(float x, float y, float z)
    {
        glm::mat4 results;
        results[0][0] = x;
        results[1][1] = y;
